...
try:
    ...
    log_logger.warning(f"Could not setup general_log webhook: {e}")
...
try:
    ...
    log_logger.warning(f"Could not setup warning_log webhook: {e}")
...
try:
    ...
    log_logger.warning(f"Could not setup error_log webhook: {e}")
...
try:
    ...
    log_logger.warning(f"Could not setup critical_log webhook: {e}")
