...
# Default locale, can be overridden by STUDYLION_LOCALE environment variable for private bot
import os
_DEFAULT_LOCALE = 'en_GB'
SOURCE_LOCALE = os.environ.get('STUDYLION_LOCALE', _DEFAULT_LOCALE).replace('-', '_')
