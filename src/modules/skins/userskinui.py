...
# Premium module đã bị xóa - disable gem transactions
...
class UserSkinUI(MessageUI):
    ...
    def __init__(self, bot: LionBot, userid: int, callerid: int, **kwargs):
        ...
        # Premium module đã bị xóa
        self.gems = None  # bot.get_cog('PremiumCog')
    ...
    async def _purchase_skin(self, app_skin_name: str):
        # Premium module đã bị xóa - disable purchase
        raise UserInputError(
            "Skin purchasing is disabled. Premium module has been removed."
        )
    ...
    async def gift_button_refresh(self):
        ...
        # Premium module đã bị xóa - disable gift
    ...
    async def refresh_layout(self):
        ...
        skin = self.current_skin
        if not self.is_owned:
            # Premium module đã bị xóa - luôn dùng purchase button (disabled)
    ...
    async def reload(self):
        ...
        # Premium module đã bị xóa - balance luôn là 0
        self.balance = 0
