...
# Chỉ giữ lại modules còn tồn tại sau khi tối giản hóa
...
class GuildDashboard(BasePager):
    ...
    """
    # Chỉ giữ lại 3 modules chính: Ranks, Statistics, Pomodoro
    pages = [
        (LocaleDashboard, GeneralDashboard, RankDashboard,),
        (StatisticsDashboard, TimerDashboard,),
    ]
